...
public class SearchAdmin {
    ...
    @RequestMapping(path = {"/admin/advancedSearch"}, method = {RequestMethod.GET})
    public String advancedSearch() {
        return "advancedSearch/admin";
    }

    @RequestMapping(path = {"/admin/advancedSearch/do"}, method = {RequestMethod.POST})
